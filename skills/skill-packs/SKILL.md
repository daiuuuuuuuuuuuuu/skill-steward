---
name: skill-packs
description: 专项领域调度器。当用户请求属于具体能力域（设计/动画/工程/工具/记忆）的任务时触发。通过读取对应 pack 的 PACK.md 精准匹配并加载 skill。支持双路径触发。
---
...
| 触发 ✅ | 不触发 ❌ |
|---------|----------|
| 生成界面 / 写代码 / 添加动画 / 使用工具 | 抽象方法论讨论 |
| UI 审查 / 代码审查 / 性能诊断 | 战略讨论 / 哲学思考 |
| 制作原型 / 搜索图标 / 构建 Agent | 通用问题分析 |
| 提取记忆 / 管理知识 / 优化性能 | 日常闲聊 |
...
| 用户关键词 | 能力域 | pack |
|-----------|--------|------|
| UI / 页面 / 原型 / 布局 / 视觉 / 设计审查 / 移动端 / 幻灯片 | design | design |
| 动画 / GSAP / 滚动 / 时间线 / 动效 / 性能调优 | motion | gsap |
| React / 架构 / 代码 / 状态管理 / 构建 Agent / 创建 skill | tooling | tools |
| 搜索 / 图标 / MCP / 外部工具 / 配置 | tooling | tools |
| 知识提取 / 记忆管理 / 自改进 / 决策框架 | cognition | si |
